  ...
  return (
    <div className={classes.Container}>
      ...
      <div className={classes.ContentIte}>
        ...
        <div className={classes.Element}>
          <div className={classes.BBorder}>
            <img src="http://52.183.69.113/wp-content/uploads/2020/03/e2.png" />
          </div>
          <p>Нууц үгийн хамгаалалт</p>
        </div>
        <div className={classes.Element}>
          <div className={classes.BBorder}>
            <img src="http://52.183.69.113/wp-content/uploads/2020/03/e3.png" />
          </div>
          <p>Имэйл хамгаалалт</p>
        </div>
        <div className={classes.Element}>
          <div className={classes.BBorder}>
            <img src="http://52.183.69.113/wp-content/uploads/2020/03/e1.png" />
          </div>
          <p>Гэрийн төхөөрөмжийн хамгаалалт</p>
        </div>
        <div className={classes.Element}>
          <div className={classes.BBorder}>
            <img src="http://52.183.69.113/wp-content/uploads/2020/03/e5.png" />
          </div>
